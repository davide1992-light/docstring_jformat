...
def get_formatted_docstring_script(script: str, line_length: int, justify: bool) -> str:
    ...
    Args:
        ...
        justify (bool): Whether to justify the text in the docstrings or not.
...
def format_script_docstrings(script_path: Path, line_length: int, justify: bool):
    ...
    with script_path.open("r") as f:
        script = f.read()
    new_script = get_formatted_docstring_script(script, line_length, justify)
